...
export async function apiCall<T>(method: 'GET' | 'POST' | 'PUT' | 'DELETE' | 'PATCH' ,path: string, payload: any, authenticated: boolean = true, errorMessage: string = 'Request failed.', throwError: boolean = true): Promise<T> {
